...
class GestureController:
    ...
    CAM_HEIGHT = None
    CAM_WIDTH = None
    hr_major = None # default Right Hand 
    hr_minor = None # default Left hand
    dom_hand = True
...
def stop_script():
    print("Stopping script 1...")
    sys.exit()

# Register a callback for the 'q' key
keyboard.on_press_key('q', lambda _: stop_script())
